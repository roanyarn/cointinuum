  ...
  return (
    <nav className={darkMode ? 'navbar navbar--dark' : 'navbar'}>
      <img
        ...
        src={
          darkMode
            ? 'https://res.cloudinary.com/dtzesssqo/image/upload/v1667671324/brand/newwlogo_rguatb.png'
            : 'https://res.cloudinary.com/dtzesssqo/image/upload/v1667671324/brand/newblogo_bqcjyc.png'
        }
        alt="cointinuum logo"
        onClick={onLogoClick}
      />
