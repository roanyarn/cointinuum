    ...
    <div className={darkMode ? 'solutions solutions__dark' : 'solutions'}>
      ...
      <SmallCard
        ...
        paragraph="Traditional real estate is costly, time-intensive, and complicated. With no 
				...
				estate investments."
        image="https://res.cloudinary.com/dtzesssqo/image/upload/v1667671940/solutions/animatedliquidity_eyxquy.png"
      />
      <SmallCard
        id="community"
        className={darkMode ? 'small__card small__card--dark' : 'small__card'}
      ...
      />
      <img
        className="solutions__testImage"
      ...
      <SmallCard
        ...
        image="https://res.cloudinary.com/dtzesssqo/image/upload/v1667671931/solutions/paths_nklyfc.png"
      />
      <SmallCard
        className={
          darkMode
        ...
        image="https://res.cloudinary.com/dtzesssqo/image/upload/v1667671930/solutions/vehicle_xvngrd.png"
      />
      <SmallCard
        className={darkMode ? 'small__card small__card--dark' : 'small__card'}
        ...
        image="https://res.cloudinary.com/dtzesssqo/image/upload/v1667671930/solutions/gas_kdqpjo.png"
      />
    </div>
  );
};
